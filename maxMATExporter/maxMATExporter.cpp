...
#define maxMATExporter_CLASS_ID	Class_ID(0x4f8f52f4, 0x7077ed2a)
...
class maxMATExporter : public SceneExport {
	public:
		...
		void maxMATExporter::Test (Interface *ip);
...
class maxMATExporterClassDesc : public ClassDesc2 {
	public:
	int 			IsPublic() { return TRUE; }
	void *			Create(BOOL loading = FALSE) { return new maxMATExporter(); }
	const TCHAR *	ClassName() { return GetString(IDS_CLASS_NAME); }
	SClass_ID		SuperClassID() { return SCENE_EXPORT_CLASS_ID; }
	Class_ID		ClassID() { return maxMATExporter_CLASS_ID; }
	const TCHAR* 	Category() { return GetString(IDS_CATEGORY); }

	const TCHAR*	InternalName() { return _T("maxMATExporter"); }	// returns fixed parsable name (scripter-visible name)
	HINSTANCE		HInstance() { return hInstance; }					// returns owning module handle
	

};

static maxMATExporterClassDesc maxMATExporterDesc;
ClassDesc2* GetmaxMATExporterDesc() { return &maxMATExporterDesc; }





INT_PTR CALLBACK maxMATExporterOptionsDlgProc(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam) {
	static maxMATExporter *imp = NULL;

	switch(message) {
		case WM_INITDIALOG:
			imp = (maxMATExporter *)lParam;
...
void maxMATExporter::ShowOptions(HWND hWnd)
{	
...
int maxMATExporter::ExtCount()
{
	//TODO: Returns the number of file name extensions supported by the plug-in.
	return 1;
}

const TCHAR *maxMATExporter::Ext(int n)
{		
	//TODO: Return the 'i-th' file name extension (i.e. "3DS").
	return _T("mat");
}

const TCHAR *maxMATExporter::LongDesc()
{
	//TODO: Return long ASCII description (i.e. "Targa 2.0 Image File")
	return _T("Freelancer MAT File Format");
}
	
const TCHAR *maxMATExporter::ShortDesc() 
{			
	//TODO: Return short ASCII description (i.e. "Targa")
	return _T("mat");
}

const TCHAR *maxMATExporter::AuthorName()
{			
	//TODO: Return ASCII Author name
	return _T("");
}

const TCHAR *maxMATExporter::CopyrightMessage() 
{	
	// Return ASCII Copyright message
	return _T("");
}

const TCHAR *maxMATExporter::OtherMessage1() 
{		
	//TODO: Return Other message #1 if any
	return _T("");
}

const TCHAR *maxMATExporter::OtherMessage2() 
{		
	//TODO: Return other message #2 in any
	return _T("");
}

unsigned int maxMATExporter::Version()
{				
	//TODO: Return Version number * 100 (i.e. v3.01 = 301)
	return 100;
}

void maxMATExporter::ShowAbout(HWND hWnd)
{			
	// Optional
}

BOOL maxMATExporter::SupportsOptions(int ext, DWORD options)
{
...
BOOL maxMATExporter::ExportGroup(IGameNode * pMesh, const TCHAR* name)
{
	...
	{	
		...
		{	
			...
			if(pMaterial==NULL)
			{
				MessageBox(0,"No material on one of the meshes","Error exporting Material",MB_ICONERROR);
			}
			if (pMaterial!=NULL) 
			{
				...
				{     
					...
					{    
						...
						{
							IsSelfIllum = true;
							mesh->SIname = tex->GetTextureName();
							mesh->pFilePath = pMaterial->GetIGameTextureMap(0)->GetBitmapFileName();
							mesh->pSIFilePath = tex->GetBitmapFileName();
						}
...
BOOL maxMATExporter::ExportRootMesh(IGameNode * pMesh,  const TCHAR *name)
{	
	ExportOptions OptionsDlgExport(NULL);
...
void maxMATExporter::ExportNodeInfo(IGameNode * pMesh, const TCHAR *name)
...
int	maxMATExporter::DoExport(const TCHAR *name,ExpInterface *ei,Interface *i, BOOL suppressPrompts, DWORD options)
{
